...
//
//    /**
//     * 기본 사용자 정보만 포함하는 간단한 응답 생성
//     */
//    public static UserResponseDTO simple(UserPrincipal userPrincipal) {
...
//                .isAdmin(userPrincipal.isAdminUser())
//                .build();
//    }
//
//    /**
//     * 민감정보를 제외한 공개 프로필 생성
//     */
//    public static UserResponseDTO publicProfile(UserVO user) {
...
//        return String.format("UserResponse{userId=%d, email='%s', nickname='%s', role='%s'}",
//                userId,
...
//    }
    ...
    @Deprecated
    public static UserResponseDTO fromUserVO(UserVO user) {
        return of(user);
    }

    @Deprecated  
    public static UserResponseDTO fromUserPrincipal(UserPrincipal userPrincipal) {
        return of(userPrincipal);
    }
}
